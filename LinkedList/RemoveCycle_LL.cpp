...
void solve() {
    ...
    cout << "Is LinkedList cyclic? " << (ll.isCyclic() ? "Yes" : "No") << endl; // Output: No
    // Creating a cycle for testing
    ll.tail->next = ll.head->next; // Creating a cycle
    cout << "Is LinkedList cyclic after creating a cycle? " << (ll.isCyclic() ? "Yes" : "No") << endl; // Output: Yes
    Node* startNode = ll.StartNodeCycle();
    if (startNode)
        cout << "Cycle starts at node with value: " << startNode->data << endl; // Output: Cycle starts at node with value: 25
    else
        cout << "No cycle detected in the list." << endl;
    ll.RemoveCycle();
    cout << "Is LinkedList cyclic after removing cycle? " << (ll.isCyclic() ? "Yes" : "No") << endl; // Output: No
