...
// 🔹 Main Logic Example
// -------------------------------
int Recursive_Binary_Search(vi &arr,int tar,int left,int right) {
    ...
    if(arr[mid]<tar){
        return Recursive_Binary_Search(arr,tar,mid+1,right);
    }
    else{
        return Recursive_Binary_Search(arr,tar,left,mid-1);}
